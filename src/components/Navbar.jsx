        ...
        <div className="flex justify-center items-center w-full px-4 py-3">
          ...
          <div className="flex ml-auto">
            <div className="flex items-center bg-bg-custom rounded-xl px-4 py-1 mx-2">
              ...
              <h1 className="text-gray-custom font-medium text-sm pl-1">
                {currentDate}
              </h1>
            </div>
            <div className="flex items-center bg-bg-custom rounded-xl mr-2 px-2 py-1">
              <button onClick={buttonDarkMode}>
                {isDarkMode ? "☀️" : "🌙"}
              </button>
            </div>
            <div className="flex items-center bg-bg-custom rounded-xl px-2 py-1">
              <img src={language} className="w-5" />
              <select
                value={selectedLanguage}
                onChange={handleLanguageChange}
                className="px-3 py-1 rounded-xl bg-bg-custom text-gray-custom outline-none"
              >
